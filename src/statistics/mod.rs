...
/// assert_eq!(algorithms::statistics::mean(&data), 2.0);
/// ```
...
/// dataset is sorted, then use `algorithms::statistics::median_from_sorted` instead.
///
/// Panics if dataset is empty.
///
/// ## Example
...
/// assert_eq!(algorithms::statistics::median(&data), 2.0);
///
/// let data = vec![2.0, 5.0, 3.0, 1.0];
/// assert_eq!(algorithms::statistics::median(&data), 2.5);
/// ```
...
///
/// Faster version of `algorithms::statistics::median` that can be used if you know that your dataset is already
/// sorted.
///
/// Panics if dataset is empty.
...
/// assert_eq!(algorithms::statistics::mode(&data), &1.0);
/// ```
...
/// let (range, coef_of_range, (smallest, largest)) = algorithms::statistics::range(&data);
...
///     (8.0, 10.0),
/// ];
/// assert_eq!(algorithms::statistics::chi_squared(&data), 1.91);
/// ```
